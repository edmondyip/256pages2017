<template>
  <article>
    ...
    <p>After try to build some website with javascript frameworks. I think this is the way i want to extend. I build this website with full javascript framework, also with REST API for contact form.</p>
  </article>
</template>
